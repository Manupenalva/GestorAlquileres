error id: file://<WORKSPACE>/backend/src/main/java/com/gestion/tpbackend/service/ContratoService.java:_empty_/MetodoPago#
file://<WORKSPACE>/backend/src/main/java/com/gestion/tpbackend/service/ContratoService.java
empty definition using pc, found symbol in pc: _empty_/MetodoPago#
...
public class ContratoService {
    ...
    public Contrato registrarPago(String emailInquilino, Long edificioId, Double monto, MetodoPago metodo, String nota) {
        ...
        EstadoPago estado = (metodo == Metod@@oPago.TARJETA) ? EstadoPago.PAGADO : EstadoPago.PENDIENTE;
